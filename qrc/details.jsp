...
<body>
			...
			%>
            <%
            	PreparedStatement ps = Conn.prepareStatement("SELECT * FROM CITIZEN1 WHERE UID='"+UID+"'");
		...
		<input type="button" class="btn" value="Back" onClick="window.location='index.jsp'">
...
{
	out.println("Please Enter a valid URL");
}
  %>