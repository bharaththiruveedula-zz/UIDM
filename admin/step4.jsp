...
<html>
    ...
    <body>
        <div id="wrapper">
            <header>
                <div id="title">Welcome To Admins Portal</div>
            	<div id="username">
            		<%=username%><br/>
                ...
                <div class="navbar-inner">
                    <div class="container">
                        <ul class="nav">
                            ...
                            <li><a href="step3.jsp" id="step3">View User details</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
if (getstates != null) {
                ...
                String query1 = "SELECT * from  citizen1 WHERE state='"+getstates+"' OR district='"+getdistrict+"' OR town='"+getvillage+"' ";  
                PreparedStatement Stmt1=Conn.prepareStatement(query1);
                ResultSet result1 = Stmt1.executeQuery();     
                out.println("<table border='1' cellspacing='5'><th>Username:</th><th>first name</th><th>Last Name:</th><th>Email:</th>");
                while(result1.next()){
