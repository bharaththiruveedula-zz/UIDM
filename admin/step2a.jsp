...
if (newusername1 == null && newpassword1 == null) {
...
<%	
	...
	if (newusername1 != null && newpassword1 != null) {
		...
		String query = "UPDATE agent SET password='"+newpassword1+"' WHERE username='"+newusername1+"'";
		PreparedStatement Stmt=Conn.prepareStatement(query);
		Stmt.executeUpdate();
				

out.println("<div id='inf'><h3>The Agent password is reset .</h3><br />");
